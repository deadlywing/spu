...
if __name__ == "__main__":
    prot = libspu.ProtocolKind.SEMI2K
    field = libspu.FieldType.FM64
    config = libspu.RuntimeConfig(protocol=prot, field=field)

    # config.enable_runtime_snapshot = True
    # config.snapshot_dump_dir = "./runtime_snapshots"
